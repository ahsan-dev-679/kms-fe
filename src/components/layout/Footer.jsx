  ...
  return (
    <footer className="w-full mt-10 bg-[#ECF9EE]">
      <div className="mx-auto max-w-7xl px-4 sm:px-4 lg:px-8">
        <div className="flex items-center justify-center lg:justify-between flex-col lg:flex-row pb-8 gap-7 lg:gap-0 border-b border-gray-200">
          {/* <a
            href="javascript:;"
        ...
        <div className="flex justify-between flex-col py-8 min-[500px]:py-14 gap-8 min-[500px]:gap-16 lg:gap-0 lg:flex-row">
          <div className="flex flex-col items-center max-lg:justify-center min-[500px]:items-start min-[500px]:flex-row gap-8 sm:gap-12 xl:gap-24">
            <Link
              to="/"
              className="flex justify-center lg:justify-start text-[#4FAE5A] font-bold text-2xl"
            >
              QuickBites
            </Link>
            <div className="block">
            ...
            <div className="block">
              ...
              <div class="translator-box">
                <span class="translator-flag"></span>
        ...
        <div className="py-9 border-t border-gray-200">
          <div className="flex items-center justify-center flex-col gap-8 lg:gap-0 lg:flex-row lg:justify-between">
            <span className="text-sm text-gray-500 ">
              ©<Link href="/">quickbites</Link> 2024, All rights reserved.
            </span>
